...
wrapperDiv.innerHTML = '<h2>المشروع على الأرض</h2>' +
    '<p class="main-desc">نحن نعمل على تطوير مجمع متطور مصمم خصيصًا للأفراد الذين يقدرون الحياة الحضرية المعاصرة. تم تصميم هذا المفهوم المبتكر ليتوافق تمامًا مع المعايير المميزة للمملكة العربية السعودية.</p>' +
    '<div class="statistics-wrapper">' +
    '<div class="item"><div class="number">٤</div><div class="description">دقائق الى محطة الحافلات</div></div>' +
    '<div class="item"><div class="number">٧</div><div class="description">دقائق الى مركز التسوق</div></div>' +
    '<div class="item"><div class="number">٢٥</div><div class="description">دقيقة الى المطار</div></div>' +
    '</div>'+
    '<div class="svg-with-text-wrapper"><img class="your-svg-class" src="assets/location-sign-svgrepo-com.svg" alt="Your SVG"><span class="svg-text">الرياض, المملكة العربية السعودية</span></div>';
    ;
...
sidebar.appendChild(wrapperDiv);
        ...
        var features = ['حديقة السطح', 'ساحة الالعاب', 'المواقف', 'مركز التسوق'];
        ...
        // Set innerHTML for the wrapper div
    contactWrapperDiv.innerHTML = '<h3 class="contact">تواصل معنا</h3>' +
    ...
    '</div>' +
    '<div class="col-xs-12">' +
    '<a href="mailto:muhye.alraie@gmail.com" class="btn-lrg submit-btn">إرسال</a>' +
    '</div>' +
    '</div>';
...
function showApartmentDetails(apartmentKey) {
    ...
    apartmentPrice.textContent = 'السعر: $' + apartmentDetails.price.toLocaleString(); // Format price
    apartmentSurface.textContent = 'المساحة: ' + apartmentDetails.surface + ' م²';
    apartmentAvailability.textContent = 'حالة الشقة: ' + apartmentDetails.availability;
    apartmentBedroom.textContent = 'غرف النوم: ' + apartmentDetails.bedroom;
    apartmentBathroom.textContent = 'الحمامات: ' + apartmentDetails.bathroom;
    ...
    sidebar.style.display = 'block';
     ...
     if (apartmentDetails.iframeSrc) {
        ...
        virtualTourButton.textContent = 'جولة افتراضية';
